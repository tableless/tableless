...
Pensando nisso, [quis escrever um livro](https://bit.ly/livro-web-semantica) que fala sobre a teoria da Web Semântica e como ela funciona. Não é um livro altamente técnico (poderia ser), é um livro para qualquer um ler e entender como a informação tem um papel importante na internet, e como seu relacionamento pode ser a grande virada para a extensão da Web atual.

É com muito prazer que aviso que o [livro Introdução à Web Semântica: A inteligência da informação](https://bit.ly/livro-web-semantica) foi lançado hoje pela editora Casa do Código. A versão e-book está sido por apenas R$29,90. 
...
[Compre o livro aqui!](https://bit.ly/livro-web-semantica) Use o código **DEisWS15x** para ter 15% de desconto até dia 30/09/2017!

Se você já leu o livro, por favor, [faça um review ou dê sua nota (estrelinhas) lá no GoodReads](https://bit.ly/livro-web-semantica-goodreads)!
